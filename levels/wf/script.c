...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -251, 159, -758, 0, 0, 0, (15 << 16), bhvMessagePanel),
		OBJECT(MODEL_NONE, 0, 561, 0, 0, 0, 0, (0x0A << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 0, 563, 0, 0, -180, 0, 0x00000000, bhvAirborneWarp),
		MARIO_POS(0x01, -180, 0, 179, 0),
		OBJECT(MODEL_BITS_WARP_PIPE, 163, 150, -1118, 0, 0, 0, (0x0B << 16), bhvWarpPipe),
